export let units = JSON.parse(localStorage.getItem("units")) || [
  {
    id: 1,
  ...
  },
  {
    ...
    levels: [
      { name: "Khái niệm bất phương trình bậc nhất một ẩn", state: "lock" },
      { name: "Cách giải bất phương trình bậc nhất một ẩn", state: "lock" },
      { name: "Vận dụng", state: "lock" },
  ...
  },
  {
    ...
    levels: [
      { name: "Hệ thức giữa cạnh huyền và cạnh góc vuông", state: "lock" },
      { name: "Hệ thức giữa hai cạnh góc vuông", state: "lock" },
  ...
  },
  {
    ...
    levels: [{ name: "Đường tròn", state: "lock" }],
  },
  {
    id: 14,
  ...
  },
  {
    ...
    levels: [
      { name: "Vị trí tương đối của đường thẳng và đường tròn", state: "lock" },
      { name: "Hai tiếp tuyến cắt nhau của một đường tròn", state: "lock" },
      { name: "Vận dụng", state: "lock" },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [{ name: "Vận dụng", state: "lock" }],
  },
  {
    id: 23,
  ...
  },
  {
    ...
    levels: [
      { name: "Đường tròn ngoại tiếp một tam giác", state: "lock" },
      { name: "Đường tròn nội tiếp một tam giác", state: "lock" },
      { name: "Vận dụng", state: "lock" },
    ],
  },
  {
    ...
    levels: [
      { name: "Đường tròn ngoại tiếp một tứ giác", state: "lock" },
      {
  ...
  },
  {
    ...
    levels: [
      { name: "Hình trụ", state: "lock" },
      { name: "Hình nón", state: "lock" },
      { name: "Vận dụng", state: "lock" },
    ],
  },
  {
    ...
    name: `Hình cầu`,
    levels: [
      { name: "Diện tích mặt cầu và thể tích hình cầu", state: "lock" },
      { name: "Vận dụng", state: "lock" },
