...
/**
 * The QuestionUpdate model module.
 * @module model/QuestionUpdate
 * @version 0.0.0
 */
class QuestionUpdate {
    /**
     * Constructs a new <code>QuestionUpdate</code>.
     * Data transfer object for updating all fields of an existing Question (PUT operation).
     * @alias module:model/QuestionUpdate
    ...
    constructor(chuDe, cauHoi, luaChon, giaiThich) { 
        ...
        QuestionUpdate.initialize(this, chuDe, cauHoi, luaChon, giaiThich);
    }
    ...
    /**
     * Constructs a <code>QuestionUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QuestionUpdate} obj Optional instance to populate.
     * @return {module:model/QuestionUpdate} The populated <code>QuestionUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QuestionUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>QuestionUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QuestionUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of QuestionUpdate.RequiredProperties) {
...
QuestionUpdate.RequiredProperties = ["chuDe", "cauHoi", "luaChon", "giaiThich"];

/**
 * @member {module:model/QuestionChuDe} chuDe
 */
QuestionUpdate.prototype['chuDe'] = undefined;

/**
 * @member {String} cauHoi
 */
QuestionUpdate.prototype['cauHoi'] = undefined;

/**
 * @member {Array.<module:model/QuestionLuaChonInner>} luaChon
 */
QuestionUpdate.prototype['luaChon'] = undefined;

/**
 * @member {String} giaiThich
 */
QuestionUpdate.prototype['giaiThich'] = undefined;
